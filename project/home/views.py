...
def index(request):
    ...
    lst_comvn = Domain.objects.all().filter(domain_type='comvn').order_by('sale_price').values_list('sale_price', 'vendor__name', 'vendor__logo', 'vendor__homepage')
    lst_com = Domain.objects.all().filter(domain_type='com').order_by('sale_price').values_list('sale_price', 'vendor__name', 'vendor__logo', 'vendor__homepage')
    lst_net = Domain.objects.all().filter(domain_type='net').order_by('sale_price').values_list('sale_price', 'vendor__name', 'vendor__logo', 'vendor__homepage')
    lst_org = Domain.objects.all().filter(domain_type='org').order_by('sale_price').values_list('sale_price', 'vendor__name', 'vendor__logo', 'vendor__homepage')
    lst_info = Domain.objects.all().filter(domain_type='info').order_by('sale_price').values_list('sale_price', 'vendor__name', 'vendor__logo', 'vendor__homepage')
